			...
			'error',
			{
				zones: [
					...
					},
					{
						...
						from: './src/app/pages/**/!(*public|*module)*',
						message: 'Forbidden to import from @pages',
					},
					{
						target: './src/app/shared',
					...
					{
						target: './src/app/features/accounts',
						from: [
					...
					{
						target: './src/app/features/analysis',
						from: [
					...
					{
						target: './src/app/features/categories',
						from: [
							'./src/app/features/accounts',
							'./src/app/features/analysis',
							'./src/app/features/authentication',
					...
					{
						target: './src/app/features/movements',
						from: [
							'./src/app/features/analysis',
							'./src/app/features/authentication',
							'./src/app/features/user',
